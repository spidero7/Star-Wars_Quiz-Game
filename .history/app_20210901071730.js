...
const questions = [
    ...
    {
        question: 'While Who destroyed the Droid Control Ship when they accidentally activated a Naboo Fighter’s Autopilot? Jedi use a number of crystal colors for their lightsabers, what color is preferred by the Sith?',
        answer: [
            { text: 'Purple', correct: false},
            { text: 'Blue', correct: false},
            { text: 'Red', correct: true},
